...
//Debug.Log(diatance.magnitude);
        ...
        transform.position += (Vector3.ProjectOnPlane(transform.forward, Vector3.up) * charge_speed * public_charge_speed/10 + transform.right * public_strafe_speed * private_strafe_speed)  *move_speed;
